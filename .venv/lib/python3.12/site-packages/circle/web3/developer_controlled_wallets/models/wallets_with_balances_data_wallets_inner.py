...
class WalletsWithBalancesDataWalletsInner(BaseModel):
    ...
    def __getattr__(self, name: str):
        # Don't forward dunders or pydantic-private attrs (e.g. __pydantic_*,
        # _initialised) — those should resolve on the wrapper itself or fail.
        if name.startswith("_"):
            raise AttributeError(name)
        inst = self.__dict__.get("actual_instance")
        if inst is None:
            raise AttributeError(name)
